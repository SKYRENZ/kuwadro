...
const ChooseLayoutPage = () => {
  ...
  return (
    <div className="h-screen bg-[#EFE6D5] flex flex-col items-center py-6 px-4 font-sans text-[#3D2314] relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-4xl flex items-center justify-between mb-4">
        <button 
      ...
      <div className="z-10 flex-1 w-full flex flex-col items-center justify-center">
        ...
        <p className="mt-4 text-[#6B4E31] font-serif italic text-base opacity-90 text-center max-w-sm">
