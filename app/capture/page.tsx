...
const CaptureContent = () => {
  ...
  return (
    <div className="h-screen bg-[#EFE6D5] flex flex-col items-center py-4 px-4 font-sans text-[#3D2314] relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-2xl flex items-center justify-between mb-8">
        <button 
          onClick={() => window.location.href = '/choose-layout'}
          className="text-[#FFE8D1] bg-[#8B4513] font-bold border-2 border-[#3D2314] px-6 py-2 hover:translate-x-[1px] hover:translate-y-[1px] shadow-[4px_4px_0_0_#3D2314] hover:shadow-[2px_2px_0_0_#3D2314] transition-all flex gap-3 items-center rounded-sm text-sm"
        >
          <span>←</span> New Frame
        </button>
        <h1 className="text-5xl font-black text-[#3D2314] tracking-tight uppercase drop-shadow-sm" style={{ fontFamily: "ui-serif, Georgia, serif" }}>
          {selectedLayout.name}
        </h1>
        <div className="w-[140px] flex justify-end">
          <div className="bg-[#D97732] text-[#FFE8D1] px-4 py-1.5 rounded-sm text-xs font-black border-2 border-[#3D2314] uppercase shadow-[2px_2px_0px_0px_#3D2314]">
